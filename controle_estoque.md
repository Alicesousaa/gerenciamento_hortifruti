# PI - Projeto Integrador: Controle de Estoque
...
- **JDBC (Java Database Connectivity)**: Para integração com banco de dados e persistência das informações.
- **MySQL**: Banco de dados utilizado para armazenar as informações do sistema (produtos, movimentações de estoque, etc.).
- **Swing**: Interface gráfica utilizada para interação do usuário (caso a versão tenha uma GUI).
